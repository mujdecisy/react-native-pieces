...
export const InputDateRightButton = ({handleClick, style, buttonSize}:{handleClick:()=>void, style:ViewStyle, buttonSize: number}) => {
    return (
        <ButtonIcon
            style={style}
    ...
    return (
        <>
            <Calendar
                ...
                handleChange={date=>{setStateTargetDate(date)}}/>
            <Takoz />
            <ButtonText
                label='Save'
                handleClick={ ()=>{
